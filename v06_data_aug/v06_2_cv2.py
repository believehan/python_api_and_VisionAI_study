...
img_flipped2 = cv2.flip(img, 0) # 1은 수평, 0은 수직, -1은 둘 다
img_flipped3 = cv2.flip(img, -1) # 1은 수평, 0은 수직, -1은 둘 다
...
ax[1,0].imshow(img_flipped2)
ax[1,0].axis('off')
ax[1,0].set_title("Flipped2")

ax[1,1].imshow(img_flipped3)
ax[1,1].axis('off')
ax[1,1].set_title("Flipped3")
plt.show()
